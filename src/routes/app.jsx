...
const appRoutes = [
    ...
    { path: "/admin/typography", name: "Typography", icon: "pe-7s-news-paper", component: Typography },
    ...
    { path: "/admin/notifications", name: "Notifications", icon: "pe-7s-bell", component: Notifications },
    { upgrade: true, path: "/admin/upgrade", name: "Upgrade to PRO", icon: "pe-7s-rocket", component: Upgrade },
